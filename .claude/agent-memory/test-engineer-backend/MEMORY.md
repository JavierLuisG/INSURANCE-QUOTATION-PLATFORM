...
- [plataforma-core-ohs test suite](project_test_suite.md) — Patterns, caveats, and locations for the Jest+supertest suite covering routes and middleware
- [Controller test pattern — MockitoExtension vs WebMvcTest](feedback_controller_test_pattern.md) — Keep existing plain tests; add WebMvcTest in separate *MockMvcTest.java files
